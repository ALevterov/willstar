$(document).ready(function () {
  ...
  if (window.innerWidth > 768) {
    casesCarousel = $('.cases-carousel')
  }
  if (window.innerWidth < 768) {
    casesCarousel = $('.cases-carousel_mobile')
  }
  ...
  const casesProgressBar =
    window.innerWidth < 768
      ? document.querySelector('.cases__progress_bar_mobile')
      : document.querySelector('.cases__progress_bar')
  ...
  const influenceProgressBar =
    window.innerWidth > 768
      ? document.querySelector('.influence__progress_bar')
      : document.querySelector('.influence__progress_bar_mobile')
...
let desktopHeader = `<header class="header" id="header-sticky">
...
let mobileHeader = `<div class="header__mobile" id="header-sticky"><div class="header__logo">
<svg
	width="137"
	height="25"
	viewBox="0 0 137 25"
...
let headerOffset =
  window.innerWidth < 1600 ? (window.innerHeight < 768 ? 50 : 60) : 72
...
const runningStringInner =
  window.innerWidth > 768
    ? document.querySelector('.running_string_inner')
    : document.querySelector('.running_string_inner_mobile')
let runningWord =
  window.innerWidth > 768
    ? document.getElementById('running_string_word')
    : document.getElementById('running_string_word_mobile')
...
if (window.innerWidth < 768) {
  const advantagesCarousel = $('.advantages__item_container')
  ...
  const residentsCarousel = $('.residents__cards_container')
  residentsCarousel.owlCarousel({
    margin: 41,
    nav: true,
    loop: true,
    autoWidth: true,
